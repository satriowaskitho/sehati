<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
                    ...
                    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                        <!-- Summary Start -->
                        <div class="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full summary">
                            <div
                                ...
                                <div class="space-y-4">
                                    <dl class="flex items-center justify-between gap-4">
                                        <dt class="text-base font-bold text-gray-900 dark:text-white">Jumlah Usaha</dt>
                                        <dd class="text-base font-bold text-gray-900 dark:text-white">10
                                        </dd>
                                    </dl>
                                </div>
                            </div>
                        ...
                        <!-- Daftar Taging Start-->
                        <div class="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8 shops">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                                ...
                                                <dl>
                                                    Deskripsi : Menyediakan barang keseharian, menjual barang,
                                                    akomodasi/perdagangan besar
                                                </dl>
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5 text-center">
                                ...
                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Yakin ingin
                                    menghapus hasil taging usaha ini?</h3>
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5">
                                <form class="space-y-4" action="#">
                                    <div>
                                        <label for="name"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Usaha</label>
    ...
    @push('scrollreveal-show')
        <script>
            window.sr = ScrollReveal({ duration:500, distance:'50px', easing:'ease-out'});

            sr.reveal('.summary', {origin:'bottom', reset:false})
            sr.reveal('.shops', {interval:200, origin:'bottom', reset:false})
